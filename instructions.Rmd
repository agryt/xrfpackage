...
Lastly, you can use `show_blanks()` to create a dataframe showing only the mean values for the blank samples, in case you wish to see which values are used when calculating the net count in the `convertxrf()` function. 
