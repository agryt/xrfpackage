...
data.df <- convertxrf(imported.data = imported.df, base.info = baseinfo.df, year = "2019", 
...
means.project2.df <- widen_means(project.data = data.df, first_factor = "Location", 
                                 second_factor = "Depth")
...
means.above.project.df <- widen_means_above(project.data = data.df, first_factor = 
