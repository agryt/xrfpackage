...
The output is a long data frame containing new columns showing the concentration and detection limit of each element for each sample. You will likely want to save this data frame, as this is the file you should use when doing statistical analysis, creating graphics, etc. Saving a data frame as a CSV file can be done like this:
...
Note that `write_csv()` is a function from the package **readr**. The data frame named "data.df" will then be saved in your directory as a CSV file named "my_data.csv". If you wish to save in a different format, that is entirely possible, just use your search engine!
