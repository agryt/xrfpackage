...
* `convertxrf()`: This function takes the data frame created by `readxrf()` and the data frame containing base information like crystal drift and detection limits for each element. The output of this function is a long data frame where the counts from the machine have been converted from kcps to µM. 
