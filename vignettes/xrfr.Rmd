...
* **raw.data**: This is the name of your raw data file from the XRF machine. The file must be a .txt file. 
* **project.info**: This is the name of your project information file. The file must be an Excel file, either .xlsx or .xls. 

Here is a possible input:

```{r importxrf, eval = FALSE}

imported.df <- importxrf(raw.data = "xrf_rawdata.txt", project.info = "xrf_projectinfo.xlsx")
...
* **setup**: This is the name of your "setup" file. It must be an Excel file, either .xlsx or .xls. 
...
data.df <- convertxrf(project.data = imported.df, setup = "xrf_setup.xlsx", year = "2019", first_element = "C", last_element = "As")
