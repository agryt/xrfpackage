...
The created dataframe will contain the mean blank values and look something like [this](https://github.com/agryt/xrfr/blob/master/inst/extdata/mean_blanks.csv):
