...
* `convertxrf()`: This function takes the data frame created by `readxrf()` and the file containing information like crystal drift and detection limits for each element. The output of this function is a long data frame where the counts from the machine have been converted from kcps to µM. 
...
This data frame will further be used in the function `convertxrf()`, where the values are converted from kcps to µM. 
...
* **imported.data**: The name of the data frame created after using `readxrf()`. 
* **setup**: This is the name of your data frame with the "setup" information. 
* **year**: This is the year in which the crystal drift was measured closest to when your samples were measured. 
* **first_element**: This is the name of the first column in your data frame that was created with the function `readxrf()` that is an element. For example, in the example above, there are the columns "Sample" and "Date.x" first, then the column named "C", so "C" is what we include in the function. 
* **last_element**: This is the name of the last column in your data frame that is an element. In our example, this was the column "As". 
...
* **project.data**: This is the name of the data frame created using `convertxrf()`. 
...
Running this code will give you a data frame that looks something like [this](https://github.com/agryt/xrfr/blob/master/inst/extdata/project_wide.csv):
...
The output of this code will be a data frame that looks like [this](https://github.com/agryt/xrfr/blob/master/inst/extdata/project_wide_abovedetlim.csv):
...
* **first_element**: This is the name of the first column containing concentration values in the project data frame created using `convertxrf()`.
* **last_element**: This is the name of the last column containing concentration values in the project data frame created using `convertxrf()`.
...
The output of this code will be a data frame showing the factor(s) chosen and the mean concentration for each element, like [this](https://github.com/agryt/xrfr/blob/master/inst/extdata/project_wide_means.csv): 
