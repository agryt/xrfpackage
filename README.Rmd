...
If you are using the .ssd files created by the XRF machine rather than the .txt file, you will need to convert your data from hexadecimal to readable text first. To do this, follow the [instructions](https://github.com/agryt/xrfr/blob/master/INSTRUCTIONS.pdf) on how to use the `transformssd()` function. This requires some preparation of your data before importing to R and using the function. 
